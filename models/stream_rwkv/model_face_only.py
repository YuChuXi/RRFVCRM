...
class RWKV_Steram(pl.LightningModule):
    def __init__(self, args):
        ...
        self.head_in_bak = nn.Linear(
            args.face_size, #args.f0_size + args.vo_size + args.hubert_size + args.time_size,
            args.n_embd,
        )
    ...
    def forward(
        ...
        #bak_emb = self.head_in_bak(torch.cat(face, f0, vo, hubert, time))
        bak_emb = self.head_in_bak(face)
        ...
        return (
            x[..., 0 : args.f0_size],
            x[..., args.f0_size : args.f0_size + args.vo_size],
            x[
                ...,
                args.f0_size
                + args.vo_size : args.f0_size
                + args.vo_size
                + args.hubert_size,
            ],
            x[
            ...
            if (
                ...
                if n == "emb.weight":
                    ...
                    for kk in zero:
                        if kk in n:
                            scale = 0
                    if n in ["head_in_lm.weight", "head_in_bak.weight", "head_out.weight", "ph_emb.weight"]:
                        scale = 0.5
                    if "head_k." in n:
                        scale = 0.1
                    if "head_q." in n:
